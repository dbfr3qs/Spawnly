...
//#region src/sanitize-issues.ts
const RESTRICTED_DATA_FIELDS = { header: ["cookie"] };
/**
...
* ```
*/
const sValidator = (target, schema, hook) => (0, hono_validator.validator)(target, async (value, c) => {
