...
import { Context, Env, Input, TypedResponse, ValidationTargets } from "hono";
import { Handler } from "hono/types";

//#region src/index.d.ts
type HasUndefined<T> = undefined extends T ? true : false;
type FailedResponse<T> = Response & TypedResponse<{
  readonly success: false;
  readonly error: readonly StandardSchemaV1.Issue[];
  readonly data: T;
}, 400, "json">;
type MustBeResponse<T> = T extends Promise<infer U> ? Promise<MustBeResponse<U>> : T extends Response | TypedResponse ? T : never;
type Hook<T, E$1 extends Env, P$1 extends string, Target$1 extends keyof ValidationTargets = keyof ValidationTargets, R$1 extends void | Response | TypedResponse<unknown> | Promise<Response | TypedResponse<unknown> | void> = void | Response | TypedResponse<unknown> | Promise<Response | TypedResponse<unknown> | void>> = (result: ({
  success: true;
  data: T;
} | {
  success: false;
...
declare const sValidator: <Schema extends StandardSchemaV1, Target extends keyof ValidationTargets, E extends Env, P extends string, In = StandardSchemaV1.InferInput<Schema>, Out = StandardSchemaV1.InferOutput<Schema>, I extends Input = {
  ...
  out: { [K in Target]: Out };
}, V extends I = I, R extends void | Response | TypedResponse<unknown> | Promise<Response | TypedResponse<unknown> | void> = FailedResponse<ValidationTargets[Target]>>(target: Target, schema: Schema, hook?: Hook<StandardSchemaV1.InferOutput<Schema>, E, P, Target, R>) => Handler<E, P, V, MustBeResponse<R>>;
//#endregion
export { FailedResponse, type Hook, sValidator };
