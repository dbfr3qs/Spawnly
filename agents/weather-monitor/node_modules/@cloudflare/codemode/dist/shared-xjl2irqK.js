...
*/
function isToolProviderArray(tools) {
...
*/
function normalizeProviders(tools) {
	if (isToolProviderArray(tools)) return tools;
	return [{ tools }];
}
//#endregion
export { normalizeProviders as n, DEFAULT_DESCRIPTION as t };

//# sourceMappingURL=shared-xjl2irqK.js.map