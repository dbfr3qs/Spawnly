...
function filterTools(tools) {
	const filtered = {};
	for (const [name, t] of Object.entries(tools)) if (!hasNeedsApproval(t)) filtered[name] = t;
	return filtered;
}
/**
...
//#endregion
export { filterTools as n, resolveProvider as r, extractFns as t };

//# sourceMappingURL=resolve-DdyeEp3l.js.map