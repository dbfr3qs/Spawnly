import { i as ToolProvider } from "./executor-BRm90XJT.js";
import {
  a as normalizeProviders,
  i as DEFAULT_DESCRIPTION,
  n as CodeOutput,
  r as CreateCodeToolOptions,
  t as CodeInput
} from "./shared-TyFN6W7_.js";
import { t as resolveProvider } from "./resolve-DtfaKmms.js";
import { ServerTool, Tool } from "@tanstack/ai";

//#region src/tanstack-ai.d.ts
/**
 ...
 */
declare function generateTypes(tools: Tool[], namespace?: string): string;
/**
 ...
 * ```
 */
declare function tanstackTools(tools: Tool[], name?: string): ToolProvider;
/**
 ...
 * ```
 */
declare function createCodeTool(options: CreateCodeToolOptions): ServerTool;
//#endregion
export {
  type CodeInput,
  type CodeOutput,
