...
2. **An AI provider key** for the LLM-backed agents (weather chat). bootstrap
   ...
   `AI_MODEL=openai/gpt-4o`); if only an Anthropic key is configured, skip that spec.
